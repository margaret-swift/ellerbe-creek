...
Looks like it is parameter code 00060, what is that? Ah ha! It's discharge - the total amount of water moving through the stream. Makes sense since it is a USGS gauge :D
...
This is only the start of all the wonderful things you can do in R! Please reach out to Jonny or Maggie if you'd like more tutorials to dive deeper into the R world of fun.
