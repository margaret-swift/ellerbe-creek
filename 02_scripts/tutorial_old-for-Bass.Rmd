...
# The first line of code only needs to be ran once to load the package that has the p_load function! Run it by removing the "#" before clicking the play button
...
Notice that we are defining various variables. The following "a <- 3" means that we are assigning the variable "a" the number 3. You can do this with numbers, text, and datasets, you name it!
...
sky_condition<-durham_data %>% 
  ...
  count() %>% # counts the number of occurances for a given type of "Sky Condition" 
